...
A1_output <- gradesc(f = 10, lambda = 0.1,lrate = 0.01, max.iter = 100, stopping.deriv = 0.01,
                   data = data, train = data_train, test = data_test)

save(A1_output, file = "../output/A1_output.RData")
...
A2_output <- gradesc(f = 10, lambda = 0.1,lrate = 0.01, max.iter = 100, stopping.deriv = 0.01,
                   data = data, train = data_train, test = data_test)

save(result, file = "../output/A2_output.RData")
...
save(result_summary, file = "../output/rmse_test.Rdata")
```
